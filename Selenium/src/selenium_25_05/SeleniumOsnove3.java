...
●     Odlazi na stranicu za login tako sto klikne na My Account
link iz navigacije
...
---ko je zavrsio nek doradi zadatak tako sto ce pre logovanja cekirati remember me
*/
...
public class SeleniumOsnove3 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement katalonMain = driver.findElement(By.xpath("//*[@id=\"masthead\"]/div/p[1]/a"));
		katalonMain.click();;
		Thread.sleep(2000);
		...
		WebElement myAccount1 = driver.findElement(By.xpath("//*[@id=\"primary-menu\"]/ul/li[3]/a"));
		myAccount1.click();
		Thread.sleep(2000);
